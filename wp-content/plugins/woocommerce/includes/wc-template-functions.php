...
if ( ! function_exists( 'woocommerce_template_loop_product_title' ) ) {
	...
	function woocommerce_template_loop_product_title() {
		echo '<h3 class="' . esc_attr( apply_filters( 'woocommerce_product_loop_title_classes', 'product-name' ) ) . '">' . get_the_title() . '</h3>'; // phpcs:ignore WordPress.Security.EscapeOutput.OutputNotEscaped
	}
}
...
function woocommerce_output_all_notices() {
	...
	echo '<p>Вы успешно добавили товар в корзину</p><span class="popup__toggle">Просмотреть корзину</span>';
	echo '</div>';
}
